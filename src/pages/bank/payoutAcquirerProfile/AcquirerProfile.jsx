...
const AcquirerProfile = () => {
  ...
  const { postData, data, error, loading } = usePost(
    endpoints.payout.acquirerProfileList
  );
  useEffect(() => {
    postData();
  }, []);
  ...
  } = usePost(endpoints.payout.addAcquirerProfile);
  // Change status
  ...
  const {
    postData: editPayoutAcquirerProfile,
    data: editData,
    error: editError,
  } = usePost(endpoints.payout.addAcquirerProfile);
  const handleSuccess = async () => {
    await editPayoutAcquirerProfile(formData);
  };
  useEffect(() => {
        ...
        <table className="table table-responsive-sm">
          <thead>
            <tr>
              ...
              <th>Email</th> <th>Currency Code</th>
              <th>Merchant ID</th>
              <th>Merchant VPA</th>
              ...
              <th>Virtual IFSC Code</th> <th>Access Token</th>
              <th>Payment Txn Token</th>
          ...
          {data && (
            <tbody>
              {data.data.length > 0 ? (
                    ...
                    <td>
                      {edit.status && edit.index === item.acqProfileId ? (
                        <input
                          ...
                          maxLength={256}
                          onChange={handleChange}
                          defaultValue={item.debitAccount}
                        />
                      ) : (
                        item.debitAccount
                      )}
                ...
                <tr>
                  <td colSpan={21}>No Acquirer Added</td>
                </tr>
              )}
            </tbody>
          )}
          {loading && (
            <tbody>
              {" "}
              <tr>
                <td colSpan={21}>Loading acquirer profile</td>
              </tr>
            </tbody>
          )}
          {error && (
            <tbody>
              {" "}
              <tr>
                <td colSpan={21}>Error fetching acquirer profile</td>
              </tr>
            </tbody>
          )}
        </table>

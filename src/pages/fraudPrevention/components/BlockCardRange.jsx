...
import AddCardRange from "./addRuleModal/AddCardRange";
import { successMessage } from "../../../utils/messges";
const BlockCardRange = ({ userId, type }) => {
      ...
      <div>
        ...
        <div className={styles.listing}>
          <div className={styles.filter}>
            <input type="search" placeholder="Search by value" />
          </div>
          <div className={styles.table}>
            <table className="table table-responsive-sm">
              <thead>
                <tr>
                  <th>User ID</th>
                  <th>Card Range Start</th>
                  <th>Card Range End</th>
                  <th>Created Date</th>
                  <th>Action</th>
                </tr>
              </thead>

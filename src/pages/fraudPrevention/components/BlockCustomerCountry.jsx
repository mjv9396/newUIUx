...
const BlockCustomerCountry = ({ type, userId }) => {
    ...
    return (
      <div>
        ...
        <div className="d-flex justify-content-between align-items-center">
          <h6>Block Customer Country List</h6>
        ...
        <div className={styles.listing}>
          <div className={styles.filter}>
            <input type="search" placeholder="Search by country code" />
          </div>
...
export default BlockCustomerCountry;

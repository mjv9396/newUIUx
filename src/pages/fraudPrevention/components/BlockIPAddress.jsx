...
const BlockIPAddress = ({ type, userId }) => {
      ...
      <div>
        {viewAddRule && (
          <AddRule
            ...
            userId={userId}
            onSuccess={getList}
            placeholder="Enter IP:192.1.1.0"
            onClick={() => setViewAddRule(!viewAddRule)}
          />
        )}
        <div className="d-flex justify-content-between align-items-center">
          <h6>Block IP Address List</h6>
        ...
        <div className={styles.listing}>
          <div className={styles.filter}>
            <input type="search" placeholder="Search by IP" />
          </div>

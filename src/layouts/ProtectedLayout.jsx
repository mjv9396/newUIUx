...
import MerchantKycLayout from "./MerchantKycLayout";
...
const ProtectedLayout = ({ allowedRoles, children }) => {
  ...
  // Wrap with MerchantKycLayout for additional merchant protection
  return isAuthenticated ? (
    <MerchantKycLayout>{children}</MerchantKycLayout>
  ) : (
    <Navigate to="/session-out" replace />
  );
};

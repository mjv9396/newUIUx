...
const CheckoutPage = () => {
  ...
  const payentActive = async () => {
    ...
    if (msgTypes.SUCCESS_CODE.includes(response.statusCode)) {
      ...
      // console.log("first", response.data.transactionPayinRequest);
      ...
      setAmount(
        isNaN(parseFloat(response.data.transactionPayinRequest.amount))
          ? "0.00"
          : parseFloat(response.data.transactionPayinRequest.amount).toFixed(2)
      );
    }
    // console.log("🚀 ~ payentActive ~ response.data:", response.data);
  ...
  return (
    <>
      {loading ? (
        ...
        // <Box display="flex" justifyContent="center" minHeight="90vh" marginTop={5} marginBottom={5}>
        //     <Card sx={{ backgroundColor: "Highlight" }} classNameName="checkout-pane">
        //         <CardContent>
        ...
        //                                 <Typography>Order Id : {payinRequest.orderId}</Typography>
        //                             </div>
        //                             <div classNameName='col-lg-6'>
        //                                 <Typography>Business Name : {payinRequest.businessName}</Typography>
        //                             </div>
        //                             <div classNameName='col-lg-6'>
        //                                 <Typography>Email : {payinRequest.custEmail}</Typography>
        //                             </div>
        //                             <div classNameName='col-lg-6'>
        //                                 <Typography>Phone : {payinRequest.custPhone}</Typography>
        //                             </div>
        //                             <div classNameName='col-lg-6'>
        //                                 <Typography>Amount : {payinRequest.amount}</Typography>
        //                             </div>
        //                         </div>
        //                     </div>
        //                 </CardContent>
        //             </Card>
        //             <Card>
        //                 <div classNameName='m-2'>Payment Methods</div>
        //                 <CardContent>
        //                     {paymentType?.UP && (
        //                         <>
        //                             {paymentType.UP.includes(msgTypes.UPI.INTENT) && (
        //                                 <UpiIntent />
        //                             )}
        //                             {paymentType.UP.includes(msgTypes.UPI.COLLECT) && (
        //                                 <UpiCollect />
        //                             )}
        //                             {paymentType.UP.includes(msgTypes.UPI.QR) && (
        //                                 <UpiQr />
        //                             )}
        //                         </>
                      ...
                      >
                        <div className="mt-lg-95 mb-lg-50 px-xl-15">
                          ...
                          <div id="submit-btns-desktop">
                            <Button
                              variant={
                                !dirty || isValid ? "contained" : "contained"
                              }
                              type="submit"
                              ...
                              // className={
                              //   "btn w-100 border-radius-10 font-weight-bold font-size-18 py-20 mt-20 text-white"
                              // }
                            >
                              {/* <CircularProgress /> */}
                    ...
                    >
                      ...
                      >
                        <span className="font-size-12 text-white">
                          © 2025 ATMOON, All rights reserved.
                        </span>
                      </div>
                      <div

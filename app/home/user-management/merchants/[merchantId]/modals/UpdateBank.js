...
import { bankAccount, updateBankDetails } from "@/app/formBuilder/account";
...
const Overlay = ({ merchant, id, onClick, onSuccess, responseBank }) => {
  ...
  const [formData, setFormData] = useState(() =>
    updateBankDetails(responseBank, param)
  );
...
const UpdateBank = ({ name, id, onClose, onSuccess, responseBank }) => {
  return (
    <Fragment>
      {createPortal(
